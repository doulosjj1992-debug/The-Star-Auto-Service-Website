...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-black/95 backdrop-blur-md z-50 shadow-lg shadow-yellow-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <a href="#home" className="flex items-center gap-3">
              <span className="text-yellow-400 text-2xl font-black tracking-wider hover:scale-105 transition-transform">
                ★ THE STAR AUTO SERVICE
              </span>
            </a>
            <ul className="hidden md:flex gap-8">
              <li><a href="#home" className="text-white hover:text-yellow-400 font-bold transition-colors">Home</a></li>
              <li><a href="#services" className="text-white hover:text-yellow-400 font-bold transition-colors">Services</a></li>
              <li><a href="#about" className="text-white hover:text-yellow-400 font-bold transition-colors">About</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl md:text-7xl font-black mb-6 text-yellow-400 drop-shadow-[0_0_30px_rgba(251,191,36,0.8)]">
            THE STAR AUTO SERVICE
          </h1>
          <p className="text-2xl md:text-3xl mb-8 text-white font-light tracking-wide">
            Your Neighborhood Mechanic Shop
          </p>
          <a 
            href="tel:9722312886"
            className="inline-block bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-8 py-4 rounded-full text-xl font-black hover:scale-110 transition-transform shadow-lg shadow-yellow-500/50"
          >
            📞 (972) 231-2886
          </a>
        </div>
      ...
      {/* Mission Section */}
      <section id="about" className="py-20 px-4 bg-gradient-to-b from-black via-blue-900 to-black">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black text-yellow-400 mb-8">Our Mission</h2>
      ...
      <section id="services" className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-yellow-400 mb-12 text-center">Our Services</h2>
      ...
      {/* Reviews Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-black via-blue-900 to-black">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-yellow-400 mb-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index}
                className="bg-white/95 text-gray-800 p-8 rounded-2xl shadow-xl"
              >
                <div className="text-yellow-400 text-2xl mb-4">★★★★★</div>
                <p className="italic mb-4 text-gray-700">&ldquo;{review.text}&rdquo;</p>
      ...
      <section className="py-20 px-4 bg-gray-100 text-gray-900">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-blue-900 mb-12 text-center">Visit Us Today</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
                <h3 className="text-2xl font-bold text-blue-900 mb-3">📍 Address</h3>
                <p className="text-lg">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg">
                <h3 className="text-2xl font-bold text-blue-900 mb-3">🕐 Hours</h3>
                <p className="text-lg">
      ...
      <footer className="bg-black text-white py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="text-3xl font-black text-yellow-400 mb-6">★ THE STAR AUTO SERVICE</div>
      ...
      <a
        href="tel:9722312886"
        className="fixed bottom-8 right-8 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-6 py-4 rounded-full font-black shadow-lg shadow-yellow-500/50 hover:scale-110 transition-transform z-50"
